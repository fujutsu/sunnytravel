...
<div id="single-room"  class="booking-item-details">
	...
	<?php
        ...
        if($layout && !empty($layout))
        {
            ...
            echo do_shortcode('
                [vc_row][vc_column width="2/3"][st_rental_room_header][st_rental_room_content][st_rental_room_facility choose_taxonomies="room_rental_type"][st_rental_room_gallery style="slide"][/vc_column][vc_column width="1/3"][st_related_rental_room header_title="Related Rental Room" number_of_room="5" show_excerpt="yes"][/vc_column][/vc_row][vc_row full_width="" parallax="" parallax_image="" row_fullwidth="no" parallax_class="no" bg_video="no" row_id=""][vc_column width="2/3" css=".vc_custom_1435720542975{padding-top: 20px !important;}"][st_rental_room_review][/vc_column][vc_column width="1/3"][/vc_column][/vc_row]
            ');
        }
    ?>
</div>
