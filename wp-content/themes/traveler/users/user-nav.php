    ...
    <div class="top-user-area clearfix">
        <ul class="top-user-area-list list list-horizontal list-border ">
            ...
            <li class="top-user-area-lang nav-drop qtranslate">
                ...
                ?>
                <a href="#">
                    <img src="<?php echo esc_attr($flag_dir.$flags[$current_language]) ; ?>" alt="<?php echo esc_attr($lang_name) ; ?>" title="<?php echo esc_attr($lang_name) ; ?>"><?php echo esc_attr($lang_name) ; ?><i class="fa fa-angle-down"></i><i class="fa fa-angle-up"></i>
                ...
                <ul class="list nav-drop-menu" style="min-width:120px">
                    ...
                    if (!empty($variable) and is_array($variable)){
                        foreach ( $variable as $key => $value) { 
                            $qtrans_link = qtranxf_convertURL(get_permalink(),$value, false, true);            
