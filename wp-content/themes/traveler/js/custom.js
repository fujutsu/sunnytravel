jQuery(document).ready(function ($) {
    ...
    jQuery('ul.slimmenu li.slimmenu-sub-menu a:contains("Горнолыжные туры")')
        .css('background', '')
        .mouseover(function() {
            jQuery(this).css('background', '#FF5B44');
        })
        .mouseleave(function() {
            jQuery(this).css('background', '');
        });
    jQuery('ul.slimmenu li.slimmenu-sub-menu a:contains("Экскурсионные туры")')
        .css('background', '')
        .mouseover(function() {
            jQuery(this).css('background', '#FF5B44');
        })
...
jQuery(document).ready(function ($) {
	...
	setInterval(function(){
		...
		if( $('#fancybox-wrap').is(':visible') )
			$('#dark_background_popup').addClass('to_blur');
		else if( $('#fancybox-wrap').is(':hidden') )
			$('#dark_background_popup').removeClass('to_blur');	
		
		$('.trigger_demo2').click(function(){
			$('#contact_form_pop5').css('height', '730px');
		});
		
		$('.activetrigger_demo2, li a').click(function(){
			$('#contact_form_pop5').css('height', '550px');
		});
