...
if(isset($item_id) and $item_id):
    ...
    if($type_price=='people_price')
    {
        ...
        $adult_price = get_price_by_discount_person($item_id ,$adult_price, $adult_num , true);
        $child_price = get_price_by_discount_person($item_id ,$child_price, $child_num , false);
    }
            ...
            <ul class="booking-item-payment-price">
                <?php if($type_price=='people_price'):?>
                    <li>
                        ...
                        <p class="booking-item-payment-price-amount"><?php echo ($adult_num).' x '.st_get_discount_value($adult_price,$count_sale)  ?>
                        </p>
                    </li>
                    <li>
                        <p class="booking-item-payment-price-title"><?php _e('Children Price',ST_TEXTDOMAIN) ?> </p>
                        <p class="booking-item-payment-price-amount"><?php echo ($child_num).' x '.st_get_discount_value($child_price,$count_sale)  ?>
                        </p>
                    </li>
                <?php else: ?>
                    <li>
                ...
                if(isset($item['data']['deposit_money']))
                {
                    ...
                    $orgine_price=STCart::get_item_total($item,$item_id);
                    ?>

                    <li>
                        <p class="booking-item-payment-price-title"><?php echo __('Origin Price',ST_TEXTDOMAIN); ?> </p>
                        <p class="booking-item-payment-price-amount"><?php echo TravelHelper::format_money($orgine_price)?>
                        </p>
                    </li>
                    <li>
