        ...
        <li>
            <ul class="booking-item-payment-price">
                ...
                <li>
                    ...
                    <p class="booking-item-payment-price-amount"><?php echo ($adult_num).' x '.$adult_price ?>
                    </p>

                </li>
                <li>
                    <p class="booking-item-payment-price-title"><?php _e('Children Price',ST_TEXTDOMAIN) ?> </p>
                    <p class="booking-item-payment-price-amount"><?php echo ($child_num).' x '.$child_price  ?>
                    </p>
                </li>

                <?php endif;?>
                <?php if($type_price=='tour_price'):?>
                <li>
                    <p class="booking-item-payment-price-title"><?php st_the_language('tour_number')?> </p>
                    <p class="booking-item-payment-price-amount"><?php echo esc_html($item['number'])." x ".TravelHelper::format_money($item['data']['price_sale']);?>
                    </p>
                </li>
                <?php endif;?>
