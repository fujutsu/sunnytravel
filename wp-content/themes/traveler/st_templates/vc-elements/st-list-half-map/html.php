<div class="row">
        ...
        <div class="col-md-6 st_gmap">
            <div id="gmap_wrapper" class="st_list_half_map">
                <div class="content_map" style="height: <?php echo esc_html( $height ) ?>px">
                    <div id="list_half_map" class="gmap3" style="height: <?php echo esc_html( $height ) ?>px; width: 100%"></div>
                </div>
    ...
    <?php endif; ?>
    <div class="col-md-6 reset_map" style="height: <?php echo esc_html( $height ) ?>px;">
            ...
            <div id="gmap_wrapper" class="st_list_half_map">
                ...
                <div class="gmap-controls">
                    <div id="gmap-control">
                        ...
                        <span class="st_my_location" style="display: block;"><i class="fa fa-map-marker"></i><?php _e( "My Location" , ST_TEXTDOMAIN ) ?></span>
                        <span class="st-gmap-full-half" data-full='<i class="fa fa-arrows-alt"></i><?php _e( "Fullscreen" , ST_TEXTDOMAIN ) ?>' data-no-full='<i class="fa fa-square-o"></i><?php _e( "Default" , ST_TEXTDOMAIN ) ?>'>
                            <i class="fa fa-arrows-alt"></i><?php _e( "Fullscreen" , ST_TEXTDOMAIN ) ?>
                        </span>
                    </div>
            ...
            var options = {
                ...
                success: function (data) {
                    ...
                    for (var key in data.data_map) {
                        ...
                        $('.data_list_hafl_map').append('<div class="col-md-4">' + tmp_data.content_html + '</div>');
                    }
