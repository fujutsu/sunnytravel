...
?>
<div class="st-create">
    <h2><?php echo __('Edit Activity', ST_TEXTDOMAIN); ?></h2>
</div>
<div class="msg">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input id="email" name="email" type="email"
                       placeholder="<?php st_the_language( 'user_create_activity_email' ) ?>" class="form-control" value="<?php echo get_post_meta( $post_id , 'contact_email' , true); ?>">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input id="phone" name="phone" type="phone"
                       placeholder="<?php st_the_language( 'user_create_activity_phone' ) ?>" class="form-control" value="<?php echo get_post_meta( $post_id , 'contact_phone' , true); ?>">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input id="video" name="video" type="text"
                       placeholder="<?php st_the_language( 'user_create_activity_video' ) ?>" class="form-control" value="<?php echo get_post_meta( $post_id , 'video' , true); ?>">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input id="address" name="address" type="text"
                       placeholder="<?php st_the_language( 'user_create_activity_address' ) ?>" class="form-control" value="<?php echo get_post_meta( $post_id , 'address' , true); ?>">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input id="map_lat" name="map_lat" type="text"
                       placeholder="<?php st_the_language( 'user_create_activity_latitude' ) ?>" class="form-control" value="<?php echo get_post_meta( $post_id , 'map_lat' , true); ?>">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input id="map_lng" name="map_lng" type="text"
                       placeholder="<?php st_the_language( 'user_create_activity_longitude' ) ?>" class="form-control" value="<?php echo get_post_meta( $post_id , 'map_lng' , true); ?>">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input id="map_zoom" name="map_zoom" type="text"
                       ...
                       value="<?php echo get_post_meta( $post_id , 'map_zoom' , true); ?>">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input type="text" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" name="check_in"
                       class="date-pick form-control" value="<?php echo get_post_meta( $post_id , 'check_in' , true); ?>">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input type="text" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" name="check_out"
                       class="date-pick form-control" value="<?php echo get_post_meta( $post_id , 'check_out' , true); ?>">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input name="activity-time" class="time-pick form-control" type="text"
                       placeholder="<?php st_the_language( 'user_create_activity_activity_time' ) ?>" value="<?php echo get_post_meta( $post_id , 'activity-time' , true); ?>">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input type="text" name="duration" class="form-control"
                       placeholder="<?php st_the_language( 'user_create_activity_duration' ) ?>" value="<?php echo get_post_meta( $post_id , 'duration' , true); ?>">
            ...
            <div class="col-md-12">
                <div class="form-group form-group-icon-left">
                    ...
                    <input id="price" name="price" type="text"
                           placeholder="<?php st_the_language( 'user_create_activity_price' ) ?>" class="form-control" value="<?php echo get_post_meta( $post_id , 'price' , true); ?>">
            ...
            <div class="col-md-6">
                <div class="form-group form-group-icon-left">
                    ...
                    <input id="adult_price" name="adult_price" type="text"
                           placeholder="<?php _e( "Adult Price" , ST_TEXTDOMAIN ) ?>" class="form-control" value="<?php echo get_post_meta( $post_id , 'adult_price' , true); ?>">
            ...
            <div class="col-md-6">
                <div class="form-group form-group-icon-left">
                    ...
                    <input id="child_price" name="child_price" type="text"
                           placeholder="<?php _e( "Child Price" , ST_TEXTDOMAIN ) ?>" class="form-control" value="<?php echo get_post_meta( $post_id , 'child_price' , true); ?>">
        ...
        <div class="col-md-12">
            <div class="form-group form-group-icon-left">
                ...
                <input id="discount" name="discount" type="text"
                       placeholder="<?php st_the_language( 'user_create_activity_discount' ) ?>" class="form-control" value="<?php echo get_post_meta( $post_id , 'discount' , true); ?>">
        ...
        <div class='col-md-12'>
            <div class="form-group form-group-icon-left">
                ...
                <input id="external_url" name="external_url" type="text"
                       placeholder="URL" class="form-control" value="<?php echo get_post_meta( $post_id , 'st_activity_external_booking_link' , true); ?>">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <div class="checkbox checkbox-switch">
                    <label>
                        <input name="best-price-guarantee" class="i-check"  <?php if($best_price_guarantee == 'on') echo 'checked'; ?>
