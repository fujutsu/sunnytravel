            ...
            foreach($field_list as $key=>$value){
                if(isset($field_type[$value['field_atrribute']]))
                {
                    ...
                    if(is_string($field_name))
                    {
                        switch($field_name){
                            case "pick_up":
                                echo "<input name='{$field_name}' type='hidden' value='".STInput::request('location_id_pick_up')."'>";
                                break;
                            case "drop_off":
                                echo "<input name='{$field_name}' type='hidden' value='".STInput::request('location_id_drop_off')."'>";
                                break;
                            default:
