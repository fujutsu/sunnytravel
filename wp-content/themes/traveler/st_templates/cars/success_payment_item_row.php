...
<tr>
    ...
    <td>
       ...
       <!-- <p><strong><?php /*st_the_language('booking_check_in') */?></strong> <?php /*echo @date(get_option('date_format'),strtotime($check_in)).' '.$check_in_time */?></p>
        ...
        <p><strong><?php _e("Pick-up Time: ") ?></strong> <?php echo @date_i18n(get_option('date_format').get_option('time_format'),$check_in_timestamp) ?></p>
        <p><strong><?php _e("Drop-off Time: ") ?></strong> <?php echo @date_i18n(get_option('date_format').get_option('time_format'),$check_out_timestamp) ?></p>
