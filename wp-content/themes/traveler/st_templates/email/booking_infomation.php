...
$st_cart_data = get_post_meta($order_id,'st_cart_info',true);
$st_cart_raw=$st_cart_data[$post_id];
?>
...
">
                    ...
                    <p><strong><?php _e('Number of rooms',ST_TEXTDOMAIN) ?>:</strong> <?php echo get_post_meta($order_id,'item_number',true)?></p>
                    ...
                    <?php
                    if(isset($st_cart_raw['data']['deposit_money']))
                    {
                        $deposit=$st_cart_raw['data']['deposit_money'];
                        $orgine_price=STCart::get_item_total($st_cart_raw,$post_id);
                        ?>
