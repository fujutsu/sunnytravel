...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <div class="st-select-wrapper">
        ...
        <input type="text" name="location_tax_name" class="form-control st-select-input" value="<?php echo esc_attr( $name_location); ?>" autocomplete="off" placeholder="<?php echo ($placeholder)? $placeholder:false?>">
