...
<div id="comments" class="comments-area">
    ...
    if ( (int)get_comments_number()) : ?>
        ...
        <?php endif; ?>
    <?php else: ?>
        <?php if (is_user_logged_in() || STReview::check_review_without_login()): ?>
        <p class="error"><?php echo __('No Review',ST_TEXTDOMAIN); ?><a class="ml20" href="#respond"><?php _e('Leave a review',ST_TEXTDOMAIN)?></a></p>
        <?php endif; ?>
    <?php endif; // have_comments() ?>
        ...
        <?php endif;?>
            ...
            $review_check_final = STReview::review_check_final() ;
           
            switch ($review_check_final) {
                  case "true":
