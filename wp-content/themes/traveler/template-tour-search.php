<?php
    ...
    get_header();
    $tour = new STTour();
    add_action('pre_get_posts', array(st()->tour, 'change_search_tour_arg'));
    query_posts(
        array(
            'post_type' => 'st_tours',
            's'         => '',
...
//var_dump($st_search_query->request);
    remove_action('pre_get_posts', array(st()->tour, 'change_search_tour_arg'));
    remove_filter('posts_where', array(st()->tour, '_alter_search_query'));
