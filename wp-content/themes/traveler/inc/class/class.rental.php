    ...
    class STRental extends TravelerObject
    {
        ...
        function add_to_cart()
        {
            if(STInput::request( 'action' ) == 'rental_add_cart') {
                ...
                $list_checkin = TravelHelper::getOrderByYear_2($year_checkin, 'st_rental', 'st_rental',$rental_id);
                
                $year_checkout = date('Y',strtotime($check_out));
                $list_checkout = TravelHelper::getOrderByYear_2($year_checkout, 'st_rental', 'st_rental',$rental_id);
