        ...
        if (!is_home()) {
            ...
            if (is_category() || is_single()) {
                ...
                if (is_single()) {
					...
					$tury_terms = get_the_terms( $post->ID, 'st_location_tax' );
					
					if($tury_terms){
						foreach( $tury_terms as $cur_term ){
							if( $cur_term->slug == 'tury-na-maldivy' ){
								echo '<li class="active"><a href="'. home_url() .'/tury/cyprus">Туры на Кипр</a></li>';
							}elseif($cur_term->slug == 'tury-v-dominikanu'){
								echo '<li class="active"><a href="'. home_url() .'/tury/dominikana">Туры в Доминикану</a></li>';
							}elseif($cur_term->slug == 'tury-v-egipet'){
								echo '<li class="active"><a href="'. home_url() .'/tury/egypt">Туры в Египет</a></li>';
							}elseif($cur_term->slug == 'tury-v-oae'){
								echo '<li class="active"><a href="'. home_url() .'/tury/tury-v-oae">Туры в ОАЭ</a></li>';
							}elseif($cur_term->slug == 'tury-v-shri-lanku'){
								echo '<li class="active"><a href="'. home_url() .'/tury/shri-lanka">Туры в Шри-Ланку</a></li>';
							}elseif($cur_term->slug == 'tury-po-ukraine'){
								echo '<li class="active"><a href="'. home_url() .'/tury/tury-po-ukraine">Туры по Украине</a></li>';
							}elseif($cur_term->slug == 'ekskursionnye-tury'){
								echo '<li class="active"><a href="'. home_url() .'/tury/excursions">Экскурсионные туры</a></li>';
							}
						}
					}
