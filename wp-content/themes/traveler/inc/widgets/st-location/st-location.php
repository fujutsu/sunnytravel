...
class st_location_widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<div class='location_widget_item'>
			...
			<p>
				<label><?php _e( 'Select post type' ); ?></label> 
...
class st_location_largest_selection extends WP_Widget{
	...
	public function widget( $args, $instance ) {
		...
		if (!$instance['location']){$instance['location']= get_the_ID(); }
		if (!$instance['post_type']){$instance['post_type'] = STLocation::get_post_type_list_active();}
		if (!$instance['count_review']){$instance['count_review'] = 'no' ; }
	...
	public function form( $instance ) {
		...
		<div class='location_widget_item'>
			...
			<p>
				...
				if (!empty($get_post_type_list_active) and is_array($get_post_type_list_active)){
					foreach(STLocation::get_post_type_list_active() as $key=>$value){
						?>
						<br>
						<input <?php if($post_type and in_array($value, $post_type) ){echo esc_attr('checked');};?> 
			...
			<p>
				...
				<input <?php if ($count_review=='on'){echo "checked"; } ?> type='checkbox' name='<?php echo balancetags($this->get_field_name('count_review'));?>'/>
			</p>
			<p>
