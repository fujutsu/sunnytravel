                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        <select name="type_activity" id="type_activity">
                                            <option <?php selected(get_post_meta($order,'type_activity',true),'specific_date')?> value="specific_date"><?php _e('Specific Date',ST_TEXTDOMAIN) ?></option>
                                            <option <?php selected(get_post_meta($order,'type_activity',true),'daily_activity')?> value="daily_activity"><?php _e('Daily Activity',ST_TEXTDOMAIN) ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <label class="form-label" for="activity_time"><?php _e('Activity Time',ST_TEXTDOMAIN)?></label>
                                    <div class="controls">
                                        <input type="text" name="activity_time" value="<?php echo get_post_meta($item_id,'activity_time',true)?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-row">
