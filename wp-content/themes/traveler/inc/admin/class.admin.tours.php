            ...
            if ($column_name == 'price') {
                ...
                if($type_price == "people_price"){
                    ...
                    if(!empty($discount)){
                        ...
                        echo '<strong> '.__("Adult Price",ST_TEXTDOMAIN).': '.TravelHelper::format_money($price_adult).'</strong><br>';
                        echo '<strong>'.__("Child Price",ST_TEXTDOMAIN).': '.TravelHelper::format_money($price_child).'</strong>';
                    }
