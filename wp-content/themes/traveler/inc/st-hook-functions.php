...
//        ) ) );
    ...
    if (!function_exists('st_add_scripts')) {
        function st_add_scripts()
        {
            ...
            if(st_is_https()){
                wp_enqueue_script('gmap-apiv3', 'https://maps.googleapis.com/maps/api/js?v=3.exp&signed_in=true&libraries=places', array(), null, true);

            }else
            {
                wp_enqueue_script('gmap-apiv3', 'http://maps.googleapis.com/maps/api/js?v=3.exp&signed_in=true&libraries=places', array(), null, true);
            ...
            **/
            if(is_singular('hotel_room')){
                wp_enqueue_script('single-hotel-room-js', get_template_directory_uri() . '/js/init/single-hotel-room.js', array('jquery'), '1.1.0', true);
            }
